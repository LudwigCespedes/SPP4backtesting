"""
Script para probar estrategia KAMA con parámetros específicos en intervalos de tiempo.
...
def main():
    """Función principal."""
    print("="*60)
    print("Prueba de Estrategia KAMA por Intervalos")
    print("="*60)
    ...
    # Modifica estos valores con los parámetros que obtuviste de run_kama_strategy.py
    test_params = {
        'n1': 15,      # Período KAMA rápido
        'n2': 40,      # Período KAMA lento
        'stop': 10,    # Stop loss %
